...
# Usa SCSS para hojas de estilo
gem 'sass-rails', '~> 5.0'
# Use Uglifier as compressor for JavaScript assets
# Usar Uglifier como compresor para activos JavaScript
gem 'uglifier', '>= 1.3.0'
...
# Turbolinks hace que navegar por tu aplicación web sea más rápido. Leer más: https://github.com/turbolinks/turbolinks
gem 'jbuilder', '~> 2.5'
...
group :development do
  ...
  # Acceda a una consola IRB en las páginas de excepción o usando <%= consola %> en cualquier parte del código.
